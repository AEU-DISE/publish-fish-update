...
fish_sample_cleaned0 <- fish_sample_cleaned %>% count(StationCode, SampleDate, WaterTemp, SpecificConductance, Conductivity, 
          Turbidity, DO, pH, Secchi, MicrocystisRank) %>% 
          filter(n > 1) %>% select(-n) %>% left_join(fish_sample_cleaned) %>% View()
