...
## 2. Read in file
```{r importdata}
# Data retrieved 7/2023 from Access unless otherwise labeled
...
fish_ref <- read.csv("data_raw/Sample_20230707.csv")
fish_tax <- read.csv("data_raw/OrganismsLookUp_20230710.csv")
fish_tax_ed <- read.csv("data_raw/FishTaxonomyKISTERS.csv") #Edited for KISTERS, only has species present
smelt_gen <- read.csv("data_raw/SmeltGenetics_20230710.csv")
salm_gen <- read.csv("data_raw/SalmGenetics_20230710.csv")
seine <- read.csv("data_raw/SeineEffort_20230710.csv")
trap <- read.csv("data_raw/TrapEffort_20230710.csv")
