...
BL52011 <- filter(fish_catch_clean, EventID == "4779") # seine was re-done
BL52011dup <- filter(fish_catch_clean, EventID == "4780") #second seine done due to gear issue - should not have been entered (discovered in JTs beach seine analysis) 
