...
BL1 <- filter(fish_catch_clean, EventID == "6760")
BL1dup <- filter(fish_catch_clean, EventID == "6758") #no FL entered so this is duplicated entry (discovered in JTs beach seine analysis)
BL52011 <- filter(fish_catch_clean, EventID == "4779")
