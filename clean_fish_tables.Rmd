...
fish_ref_clean <- fish_ref %>% 
  ...
  rename(WaterTemp = WaterTemperature,
         ...
         GearCode = GearID,
         EventID = SampleID)%>%
  filter(!(EventID == "6600" | EventID == "7749")) %>% #filters 2 duplicated entries found in JTs beach seine analysis
...
#add in duplicate removal found in JTs beach seine analysis here --- 

# filter out duplicate samples from resample on 6-27-2011 due to gear issues (partial bag twist)
# Station: BL5, date: 6-27-2011 fish: LP, GSN, MSS, SAPM, SPLT, STB, Tule Perch, Shimo Goby 
# event ID 4780 - reference data sheet for correct org ID and FL

BL5 <- filter(fish_catch_QC2, EventID == 4780)
  


# remove duplicate on 2-3-2016
# station BL1 - BGS, 2-3-2016

# remove CHN recorded with count of 3 on 4-27-2017
# station BL5, CHN, 4-27-2017

# BL6, 10-22-2015 duplicate entry - event ID 6586 and 6600


# BL5, 3-29-2016 MSS with count of 2 - delete

# AL1, 7-18-2017 duplicate entry - event ID 7677 and 7749
