...
## 2. Read in file
```{r importdata}
# Data retrieved 7/14/2023 from Access unless otherwise labeled
...
effort <- read.csv("data_raw/YBFMP_TrapHours_2010_2023.csv")
fish_stations <- read.csv("data_raw/YBFMP_Stations_Coordinates_Info_20230815.csv")
fish_ref <- read.csv("data_raw/Sample_20230720.csv")
fish_tax <- read.csv("data_raw/OrganismsLookUp_20230714.csv")
fish_tax_ed <- read.csv("data_raw/FishTaxonomyKISTERS.csv") #Edited for KISTERS, only has species present
smelt_gen <- read.csv("data_raw/SmeltGenetics_20230714.csv")
salm_gen <- read.csv("data_raw/SalmGenetics_20230905.csv")
seine <- read.csv("data_raw/SeineEffort_20230720.csv")
trap <- read.csv("data_raw/TrapEffort_20230720.csv")
...
fish_ref_clean <- fish_ref %>% 
  ...
  mutate(SampleAltered = ifelse(SampleDate<ymd("2023-07-01"), NA, SampleAltered)) %>%
