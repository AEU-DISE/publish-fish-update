...
effort <- read.csv("data_raw/YBFMP_TrapHours_2010_2024.csv")
fish_stations <- read.csv("data_raw/YBFMP_Stations_Coordinates_Info_20250219.csv")
fish_ref <- read.csv("data_raw/Sample_20241218.csv")
...
seine <- read.csv("data_raw/SeineEffort_20241218.csv")
trap <- read.csv("data_raw/TrapEffort_20241218.csv")
