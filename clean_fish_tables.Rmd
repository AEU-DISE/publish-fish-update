...
fish_ref <- read.csv("data_raw/Sample_20251008.csv")
...
salm_gen <- read.csv("data_raw/SalmGenetics_20250128.csv")
seine <- read.csv("data_raw/SeineEffort_20251008.csv")
trap <- read.csv("data_raw/TrapEffort_20251008.csv")
...
# 10137, 10161, 10225, 10257, 10348, 10367
