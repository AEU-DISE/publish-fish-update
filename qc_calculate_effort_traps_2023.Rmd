...
## Edited by L. Vance on July 2023 to include through June 2023 data
...
sample <- read.csv("data_raw/Sample_20230707.csv")
effort <- read.csv("data_raw/TrapEffort_20230710.csv")
...
fykeNotSet_ids <- c(3192, 7118, 7641, 8050, 8051, 8361, 9407, 9408, 9409, 9410, 9485, 9950)
...
#remove rows with comments that indicate the fyke was not set
fykeNotSet_ids <- c(3192, 7118, 7641, 8050, 8051, 8361, 9261, 9407, 9408, 9409, 9410, 9485, 9950)
