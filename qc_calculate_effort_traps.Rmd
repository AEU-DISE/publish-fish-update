...
sample <- read.csv("data_raw/Sample_20241218.csv")
effort <- read.csv("data_raw/TrapEffort_20241218.csv")
...
```{r}
write.csv(sampeffort.hours, file = "data_raw/YBFMP_TrapHours_2010_2024.csv", row.names = FALSE)
```
